...
#setproctitle.setproctitle('lamers c, do not use GPU 0-7 please')
...
def test_skippy():
    ...
    vla = {'featurewise_center': False, 'filters_11': 392, 'filters_4': 426, 'height_shift_range': 0.4596736755137424, 'stack_3': 3, 'k_6': 7, 'batch_size_sp': 60, 'dropout_6': 0.2860825212460128, 'l2': 0.0012095274160256063, 'k_8': 2, 'k_1': 9, 'stack_6': 1, 'skstart_0': 1, 'channel_shift_range': 0.043232545441001954, 'stack_5': 4, 'k_12': 6, 'stack_0': 6, 'k_5': 4, 's_6': 2, 's_2': 4, 'filters_10': 84, 'skstep_4': 5, 'dropout_5': 0.29376084301164446, 'k_9': 6, 'skstep_1': 5, 'cval': 0.982286258622267, 's_0': 4, 'global_pooling': True, 'k_3': 9, 'k_10': 8, 'filters_0': 22, 'filters_9': 593, 'activation': 'elu', 'dense_size_0': 670, 'zca_whitening': False, 'skstart_2': 1, 'dropout_7': 0.40081118051262693, 'skstart_4': 4, 'filters_1': 295, 'dropout_3': 0.0346318503770567, 'dense_size_1': 1361, 'filters_12': 416, 'shear_range': 23.70750226325765, 'skstart_1': 4, 'dropout_2': 0.30030294934339613, 'dropout_4': 0.05144776056497155, 'stack_2': 1, 'filters_6': 104, 'lr': 0.00409595321818448, 's_1': 3, 'k_4': 8, 'rotation_range': 0, 'filters_5': 145, 'filters_8': 417, 'k_13': 12, 'skstep_2': 2, 'skstep_0': 7, 'zoom_range': 0.3169314712812488, 'dropout_0': 0.008226844644251292, 'activ_dense': 'softmax', 'k_7': 14, 'stack_4': 6, 'zca_epsilon': 1.2511471583282654e-06, 'k_2': 8, 'max_pooling': True, 'stack_1': 1, 's_4': 3, 'k_11': 9, 'vertical_flip': True, 'filters_7': 427, 'horizontal_flip': True, 'featurewise_std_normalization': False, 'fill_mode': 'reflect', 'step': True, 'filters_3': 540, 'skstep_3': 8, 'samplewise_center': False, 's_3': 1, 'filters_2': 283, 'width_shift_range': 0.004060864669245379, 'skstart_3': 7, 'dropout_8': 0.11082488316473282, 'samplewise_std_normalization': False, 's_5': 3, 'dropout_9': 0.07429970715358927, 'k_0': 4, 'dropout_1': 0.11214869615269163, 'filters_13': 519}
    print(X)
    print(X[0].to_dict())
