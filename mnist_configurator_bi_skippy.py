...
filters = OrdinalSpace([10, 128], 'filters') * 14#128 should be 600
kernel_size = OrdinalSpace([1, 8], 'k') * 14
strides = OrdinalSpace([1, 5], 's') * 7
stack_sizes = OrdinalSpace([0, 2], 'stack') * 7#[0,2] should be [0,7]
...
opt = mipego(search_space, objective, time_model, loss_model, ftarget=None,
                 ...
                 available_gpus=available_gpus, bi=True, save_name='data_skippy_mnist_small_sp',ref_time=None,ref_loss=None,ignore_gpu=ignore_gpu)
