...
def CNN_conf(cfg,epochs=1,test=False,gpu_no=0,verbose=0,save_name='skippy_test_train_hist_aug_tr_tw',data_augmentation=True, use_validation=True, test_on_validation=False):
    #batch_size = 100
    num_classes = 10
    num_predictions = 20
...
def test_skippy():
    ...
    with open('skippy_test_train_hist_aug_tr_tw' + '_eval_train_hist.json', 'w') as f:
        f.write('')
